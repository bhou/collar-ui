...
(function win() {
	var winTemplate = '<div class="{WIN_TYPE}">' + '<div class="win-tlo"></div>' + '<div class="win-tli"></div>' + '<div class="win-tro"></div>' + '<div class="win-tri"></div>' + '<div class="win-blo"></div>' + '<div class="win-bli"></div>' + '<div class="win-bro"></div>' + '<div class="win-bri"></div>' + '<div class="win-content">' + 'HELLO' + '</div>' + '</div>';
